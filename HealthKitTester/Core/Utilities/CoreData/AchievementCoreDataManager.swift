...
class AchievementCoreDataManager {
  ...
  func seedAchievements() {
    ...
    let ach7 = Achievement(entity: achievmentEntity, insertInto: viewContext)
    ach7.name = "Cornfield Chaser"
    ach7.order = Int32(7)
    ach7.caption = "Interstellar! You have completed 100 weekly challenges."
    ach7.earned = false
    ach7.colorA = "000000"
    ach7.colorB = "130F40"
    ach7.colorC = "335C81"
    ...
    let ach8 = Achievement(entity: achievmentEntity, insertInto: viewContext)
    ach8.name = "Forrest Gump"
    ach8.order = Int32(8)
    ach8.caption = "Walked over 100,000,000 steps."
    ach8.earned = false
    ach8.colorA = "0BAB64"
    ach8.colorB = "3BB78F"
    ach8.colorC = "8693AB"
